local LOOTPLS_RAID_BUTTON_OFFSET = 2;

function LootPlsRaidFrame_OnLoad(self)
	LootPlsFrame_RegisterPanel(self);
	LootPlsRaidContainer.update = LootPlsRaid_Update;
	HybridScrollFrame_CreateButtons(LootPlsRaidContainer, "LootPlsStandingsButtonTemplate", 0, 0, "TOPLEFT", "TOPLEFT", 0, -LOOTPLS_RAID_BUTTON_OFFSET, "TOP", "BOTTOM");
...
function LootPlsRaid_Update()
	local scrollFrame = LootPlsRaidContainer;
